...
type AuthServiceClient interface {
	...
	SendVerificationEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*GenericResponse, error)
...
func (c *authServiceClient) SendVerificationEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	SendVerificationEmail(context.Context, *EmailRequest) (*GenericResponse, error)
...
func (UnimplementedAuthServiceServer) SendVerificationEmail(context.Context, *EmailRequest) (*GenericResponse, error) {
...
func _AuthService_SendVerificationEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SendVerificationEmail(ctx, req.(*EmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "auth-service/proto/auth/auth.proto",
}
